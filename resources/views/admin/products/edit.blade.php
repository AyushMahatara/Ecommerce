                    ...
                    <div class="center">
                        ...
                        <form action="{{ url("/update_product", $product->id) }}" method="POST"
                            ...
                            <div class="div_design">
                                ...
                                <input class="input_color" type="text" name="title" placeholder=""
                            ...
                            <div class="div_design">
                                ...
                                <input class="input_color" type="number" name="price" value="{{ $product->price }}"
                                    required>
                            </div>
                            ...
                            <div class="div_design">
                                ...
                                <input class="input_color" type="text" name="dis_price"
